...
public class ImageResolver {
	...
	public Map<String, BufferedImage> resolveImage() throws IOException {
		...
		processRightImage(result);
		processLeftImage(result);
		return result;
	}

	private void processRightImage(Map<String, BufferedImage> result) throws IOException {
		BufferedImage right = ImageIO.read(new File("./../../frontend/tw-app/src/assets/topbutton-right.png"));
	...
	private void processLeftImage(Map<String, BufferedImage> result) throws IOException {
		BufferedImage left = ImageIO.read(new File("./../../frontend/tw-app/src/assets/topbutton-left.png"));
